...
// Напишите функцию limitStr(str, n, symb),
// которая обрезает строку, если она длиннее
// указанного количества символов n. Усеченная
// строка должна заканчиваться троеточием «...»
